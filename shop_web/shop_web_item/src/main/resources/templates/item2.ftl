...
<div class="hd-info1 w1200">
    ...
    <div class="search f-r">
        ...
        <#-- TODO 搜索 -->
        <form method="post" action="http://localhost:8082/search/searchByKeyWord">
            <div class="srh">
                <div class="ipt f-l">
                    <input type="text" placeholder="搜索商品" name="keyWord" ss-search-show="sp" />
                    <!--<input type="text" placeholder="搜索店铺..." ss-search-show="dp" style="display:none;" />-->
                </div>
                <button type="submit" class="f-r">搜 索</button>
                <div style="clear:both;"></div>
            </div>
        </form>
        <ul class="sp2">
    ...
    <div class="deta-info1">
        <div class="dt-if1-l f-l">
            <div class="dt-if1-datu">
                <ul qie-da="">
                    <#-- TODO 商品内容 -->
                    <li><a href="${product.proImages}"><img src="${product.proImages}" style="height: 359px;width: 351px"/></a></li>
                    <div style="clear:both;"></div>
                </ul>
            </div>
            <div class="dt-if1-qietu">
                ...
                <div class="dt-qie-con f-l">
                    <ul qie-xiao="">
                        <li class="current"><a href="${product.proImages}"><img src="${product.proImages}" style="width: 60px;height: 60px;"/></a></li>
                        <div style="clear:both;"></div>
                    </ul>
                </div>
        ...
        <div class="dt-if1-m f-l">
            <div class="dt-ifm-hd">
                <h3><a href="javascript:;">${product.proName}</a></h3>
                <p>${product.proSalePoint}</p>
            </div>
            <div class="dt-ifm-gojia">
                <dl>
                    ...
                    <dd>
                        <p class="p1">
                            <span class="sp1">¥${product.proSalePrice}</span><span class="sp2">${product.proPrice}</span>
                        </p>
                        <p class="p2">
            ...
            <div >
                <dl class="dt-ifm-spot">
                    <#-- TODO 商品下架 -->
                    <span style="color: red;size: A5">该商品已下架</span>
                    <a href="http://localhost:8081/">返回主页</a>
                </dl>
            </div>
        </div>
